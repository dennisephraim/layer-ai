...
export class GoogleAdapter extends BaseProviderAdapter {
  ...
  private async handleChat(
    ...
    if (chat.maxTokens !== undefined)
      generationConfig.maxOutputTokens = chat.maxTokens;
    if (chat.topP !== undefined) generationConfig.topP = chat.topP;
    if (chat.stopSequences !== undefined)
      generationConfig.stopSequences = chat.stopSequences;
